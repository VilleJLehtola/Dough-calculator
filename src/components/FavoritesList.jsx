...
export default function FavoritesList({ user, onLoadFavorite }) {
  ...
  return (
    <div className="max-w-xl mx-auto p-4">
      <h2 className="text-2xl font-semibold mb-4 text-center">Suosikit</h2>

      {loading ? (
        <p className="text-center text-gray-500">Ladataan...</p>
      ) : favorites.length === 0 ? (
        <p className="text-center text-gray-500">Ei tallennettuja suosikkeja.</p>
      ) : (
            ...
            {favorites.map((fav) => {
              ...
              return (
                <motion.li
                  ...
                  className="bg-white rounded-2xl shadow-md p-4 border relative"
                >
